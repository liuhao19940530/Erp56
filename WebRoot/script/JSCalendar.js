...
/**
  ...
  */
var curPath = window.document.location.href;//获取当前网址
var pathName = window.document.location.pathname;//获取主机名之后的目录

var projectPath = pathName.substring(0,pathName.substr(1).indexOf('/')+1);//获取的是工程名 /erp55

var _sNeededImagesFilePath = projectPath+"/images/";
var _sNeededCSSFilePath = projectPath+"/style/";
